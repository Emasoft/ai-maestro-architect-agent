# Planning Scenarios and Patterns
...
| Your Need | Section to Read in architecture-design.md |
|-----------|-------------------------------------------|
...
| Your Need | Section to Read in risk-identification.md |
|-----------|------------------------------------------|
...
| Your Need | Section to Read in roadmap-creation.md |
|-----------|----------------------------------------|
| Group work into logical phases | Step 1: Define Phases |
| Order phases by dependencies | Step 2: Sequence Phases |
| Define achievement points | Step 3: Define Milestones and Deliverables |
| Allocate people and estimate timing | Step 4: Allocate Resources |
| Create complete roadmap | Step 5: Create the Master Roadmap |

### Implementation Planning

| Your Need | Section to Read in implementation-planning.md |
|-----------|-----------------------------------------------|
...
| Assign work to team members | Step 3: Assign Owners |
| Daily tracking during execution | Step 4: Create Tracking |
